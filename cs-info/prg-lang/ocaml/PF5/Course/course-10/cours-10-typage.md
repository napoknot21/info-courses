...
Enfin, on suppose ici qu'on peut toujours générer de "nouvelles" variables de types (on dit également "fraîches"), c'est-à-dire jamais utilisées auparavant lors du problème de typage qui nous occupe.
